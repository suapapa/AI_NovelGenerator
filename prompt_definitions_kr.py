# prompt_definitions_kr.py
# -*- coding: utf-8 -*-
"""
prompt_kr.yaml 에서 한국어 프롬프트를 로드합니다.

눈송이 작법, 캐릭터 아크 이론, 서스펜스 3요소 모델 등을 통합하며,
최근 장 요약/다음 장 키워드 추출 및 장 본문 작성 프롬프트를 포함합니다.

한국어 모드 활성화 시 main_window 가 본 모듈 속성을 prompt_definitions 에 주입합니다.
"""
from pathlib import Path

import yaml

_PROMPT_YAML = Path(__file__).resolve().parent / "prompt_kr.yaml"
